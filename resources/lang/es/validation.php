...
return [
    ...
    | como las reglas de tamaño. Siéntete libre de modificarlas según tus necesidades.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes especificar nombres amigables para los atributos, de manera
    | que en lugar de mostrar "nombre" muestre "Nombre completo".
    |
    */
    'attributes' => [
        'nombre'    => 'nombre',
        ...
        'codigo_pc' => 'código de PC',
        'serial_pc' => 'serial de PC',
        'placa'     => 'placa',
        'marca'     => 'marca',
        'modelo'    => 'modelo',
        'color'     => 'color',
